...
frappe.ui.form.on('LinkedIn Settings', {
	onload: function(frm) {
		...
		frm.dashboard.set_headline(__("For more information, {0}.", [`<a target='_blank' href='https://docs.nbnextlinks/docs/user/manual/en/CRM/linkedin-settings'>${__('click here')}</a>`]));
	},
