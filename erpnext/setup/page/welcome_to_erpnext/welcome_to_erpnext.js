frappe.pages['welcome-to-erpnext'].on_page_load = function(wrapper) {
	...
	parent.find(".video-placeholder").on("click", function() {
		...
		parent.find(".embed-responsive").append('<iframe class="embed-responsive-item video-playlist" src="https://www.nbnextlinks/embed/videoseries?list=PL3lFfCEoMxvxDHtYyQFJeUYkWzQpXwFM9&color=white&autoplay=1&enablejsapi=1" allowfullscreen></iframe>')
	});
